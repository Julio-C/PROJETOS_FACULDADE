...
namespace Prova_saiz.funcionarioDataSetTableAdapters {
    ...
    public partial class funciTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [funci] WHERE (([id_fun] = @Original_id_fun) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_cadseco = 1 AND [cadseco] IS NULL) OR ([cadseco] = @Original_cadseco)) AND ((@IsNull_Salario = 1 AND [Salario] IS NULL) OR ([Salario] = @Original_Salario)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [funci] ([Nome], [cadseco], [Salario]) VALUES (@Nome, @cadseco, @Sala" +
                "rio);\r\nSELECT id_fun, Nome, cadseco, Salario FROM funci WHERE (id_fun = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [funci] SET [Nome] = @Nome, [cadseco] = @cadseco, [Salario] = @Salario WHERE (([id_fun] = @Original_id_fun) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_cadseco = 1 AND [cadseco] IS NULL) OR ([cadseco] = @Original_cadseco)) AND ((@IsNull_Salario = 1 AND [Salario] IS NULL) OR ([Salario] = @Original_Salario)));
SELECT id_fun, Nome, cadseco, Salario FROM funci WHERE (id_fun = @id_fun)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        id_fun, Nome, cadseco, Salario\r\nFROM            funci\r\nWHERE       " +
                " (cadseco = @code)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@code", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "cadseco", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO funci\r\n                         (Nome, cadseco, Salario)\r\nVALUES     " +
                "   (@Nome,@cadseco,@Salario)";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@cadseco", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "cadseco", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Salario", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "Salario", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(funcionarioDataSet.funciDataTable dataTable, string code) {
        ...
        public virtual funcionarioDataSet.funciDataTable GetData(string code) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((code == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            funcionarioDataSet.funciDataTable dataTable = new funcionarioDataSet.funciDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(funcionarioDataSet.funciDataTable dataTable) {
        ...
        public virtual int Inserir(string Nome, string cadseco, global::System.Nullable<decimal> Salario) {
            ...
            if ((cadseco == null)) {
                ...
                command.Parameters[1].Value = ((string)(cadseco));
            }
            if ((Salario.HasValue == true)) {
                command.Parameters[2].Value = ((decimal)(Salario.Value));
            }
            else {
